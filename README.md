*Note: Forked from here: https://github.com/richardlehane/doctool as a Sandbox repository. Code changes if useful to be suggested to Richard and the original doctool repo. 
